...
var param = {
    ...
    exclusion:{  // Indicar en la lista las clases y años a excluir en el filtro
      ...
      years  : [1990,2000],  //lista de años a excluir con todas la clases
    }
};
...
var assetRegions = paths.regionVectorBuffer
...
if(param.version_input == 1 || param.version_input == 3){
    ...
    if(param.version_input == 1){
      image = ee.Image(assetPath  + '-' + version_input+'-c2');
    }else{
      image = ee.Image(assetPath  + '-' + version_input);
    }
