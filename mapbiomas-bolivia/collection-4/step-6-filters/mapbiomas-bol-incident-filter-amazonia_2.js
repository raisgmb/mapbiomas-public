...
var param = {
    ...
    version_input_class:1, //  Clasificacion de entrada (ojo no es el paso 13-1)
    version_output:2, //    Salida 
...
if (param.version_input_class==1 || param.version_input_class==3){
  dirinput = paths.classificationRaisg
}            
