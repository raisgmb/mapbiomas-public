...
var P1_and = ee.FeatureCollection("projects/mapbiomas-raisg/MUESTRAS/PERU/COLECCION4/OTROS/muestras-P1-andes-pacifico"),
    ...
    P6_andes_pacifico = ee.FeatureCollection("projects/mapbiomas-raisg/MUESTRAS/PERU/COLECCION4/OTROS/muestras-P6-andes-pacifico-2021"),
    P7_andes_pacifico = ee.FeatureCollection("projects/mapbiomas-raisg/MUESTRAS/PERU/COLECCION4/OTROS/muestras-P7-andes-pacifico-2021");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
//Muestras Export para CSV drive
var param = { 
  pais:'PERU', 
  mosaicRegion:'704', //Region de Mosaico 705=Costa  704=Andes
  regionesClass: [70401, 70402, 70403],  // andes bajo 70404, 70407, 70408    Regiones norte 70405, 70406    Regiones andes alto 70401, 70402, 70403
  regionName: 'Pacifico-Andes', //Pacifico-Andes, Pacifico-Costa
  puntos: [P1_and,P2_and, P3_and, P4_and, P5_and, P6_andes_pacifico, P7_andes_pacifico], //Puntos Colectados Anualmente //[P1_and,P2_and, P3_and, P4_and, P5_and]
  year: 2021,  // Año de los puntos colectados 
  version: '1', 
}
var assetMosaic = "projects/nexgenmap/MapBiomas2/LANDSAT/PANAMAZON/mosaics-2";
var regionClasif = "projects/mapbiomas-raisg/DATOS_AUXILIARES/VECTORES/PERU/per-noraisg-clasificacion-regiones-1"

var RegClass = ee.FeatureCollection(regionClasif)
                .filter(ee.Filter.inList('id_regionC', param.regionesClass))
print(RegClass)
...
Map.addLayer(RegClass,{},'RegClass',false)
