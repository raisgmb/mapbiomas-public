/** 
 * STEP 05-1: CÁLCULO DE AREAS PARA SORTEAR MUESTRAS DE NTRENAMIENTO 
 * Septiembre 2021 
 * DOCUMENTACIÓN:  
 * ----------------------------------------------------------------------------------------------
 */
...
var param = {
  regionId: 70508,
  referenceYear: 2021, // '' o año de referencia
  remap: {
...
(function init(param) {
  ...
  var assets = {
    ...
    // regionsRaster: 'projects/mapbiomas-raisg/DATOS_AUXILIARES/RASTERS/clasificacion-regiones-2',
    referenceImage:'projects/mapbiomas-raisg/PRODUCTOS/PERU/COLECCION4/INTEGRACION/Integracion-pacifico-beta-PERU-1',
