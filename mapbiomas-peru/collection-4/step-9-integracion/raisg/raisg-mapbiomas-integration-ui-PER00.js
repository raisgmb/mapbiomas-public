 ...
 * Export to asset
 */
var assetGrids = 'projects/mapbiomas-raisg/DATOS_AUXILIARES/VECTORES/paises-2';
...
gridNames.forEach(
    function (gridName) {
        ...
        Export.image.toAsset({
           ...
           'description': gridName.toUpperCase().replace(' ', '-') + '-' + outputVersion,
           'assetId': outputAsset + '/' + gridName.toUpperCase().replace(' ', '-') + '-' + outputVersion,
           'pyramidingPolicy': {
               ".default": "mode"
           },
