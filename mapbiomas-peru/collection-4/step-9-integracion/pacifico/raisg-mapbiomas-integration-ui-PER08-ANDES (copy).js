 ...
 *  
 */  
var outputAsset = 'projects/mapbiomas-raisg/PRODUCTOS/PERU/COLECCION4/INTEGRACION/integracion-region';
...
var App = {
    ...
    options: {
        ...
        assets: { 
            // ancilary data
            regions: 'projects/mapbiomas-raisg/DATOS_AUXILIARES/RASTERS/PERU/per-limite-Peru-1',
            ...
            collection4: 'projects/mapbiomas-raisg/COLECCION4/INTEGRACION/integracion-pais/PERU-9',
            
            // transversal data
            mang:'projects/mapbiomas-raisg/TRANSVERSALES/PERU/COLECCION4/MANGLAR/INTEGRACION/manglar4',
...
Export.image.toAsset({
   ...
   'description': 'PERU' + '-' + outputVersion + '-ANDES',
   'assetId': outputAsset + '/' + 'PERU' + '-' + outputVersion + '-ANDES',
   'pyramidingPolicy': {
       ".default": "mode"
   },
